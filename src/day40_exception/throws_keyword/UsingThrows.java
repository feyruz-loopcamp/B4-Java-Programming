...
public class UsingThrows {
    ...
    public static void test2 (int millis) throws InterruptedException{  // You must use the exception which is ITSELF or the PARENT EXCEPTIONS
